 ...
 * $Id: fggeom.h,v 2.1 1996/10/31 18:12:04 korpela Exp korpela $
 */
...
inline void i2vect_scale(FG_I2VECT *a, FG_INT scale, FG_I2VECT *result);
...
inline void i3vect_scale(FG_I3VECT *a, FG_INT scale, FG_I3VECT *result);
/* scales a vector by a fixed point scale (1.0=FG_ONE)                      */
...
inline void i4vect_scale(FG_I4VECT *a, FG_INT scale, FG_I4VECT *result);
/* scales a vector by a fixed point scale (1.0=FG_ONE)                      */
...
inline void i2x2scale(FG_I2X2 *a, FG_INT scale, FG_I2X2 *result);
...
inline void i3x3scale(FG_I3X3 *a, FG_INT scale, FG_I3X3 *result);
...
inline void i4x4scale(FG_I4X4 *a, FG_INT scale, FG_I4X4 *result);
