 ...
 * $Id: mmx.c,v 2.1 1996/10/31 18:12:04 korpela Exp korpela $
 */
#include <limits.h>
#include "fgdefs.h"
#include "fgtypes.h"
...
inline void packsswb(FG_INT16 *a, FG_INT8 *b, int n) 
...
inline void packuswb(FG_UINT16 *a, FG_UINT8 *b, int n) 
...
inline void packssdw(FG_INT32 *a, FG_INT16 *b, int n) 
...
inline void packusdw(FG_UINT32 *a, FG_UINT16 *b, int n) 
...
inline void paddb(FG_UINT8 *a, FG_UINT8 *b, FG_UINT8 *result , int n) 
...
inline void paddw(FG_UINT16 *a, FG_UINT16 *b, FG_UINT16 *result , int n) 
...
inline void paddd(FG_UINT32 *a, FG_UINT32 *b, FG_UINT32 *result, int n)
{
...
inline void paddsb(FG_INT8 *a, FG_INT8 *b, FG_INT8 *result, int n) 
...
inline void paddsw(FG_INT16 *a, FG_INT16 *b, FG_INT16 *result, int n) 
...
inline void paddusb(FG_UINT8 *a, FG_UINT8 *b, FG_UINT8 *result, int n) 
...
inline void paddusw(FG_UINT16 *a, FG_UINT16 *b, FG_UINT16 *result, int n) 
...
inline void pand(FG_VOID *a, FG_VOID *b, FG_VOID *result, int n) 
...
inline void pandn(FG_VOID *a, FG_VOID *b, FG_VOID *result, int n) 
...
inline void pcmpeqb(FG_UINT8 *a, FG_UINT8 *b, FG_UINT8 *result, int n) 
...
inline void pcmpeqw(FG_UINT16 *a, FG_UINT16 *b, FG_UINT16 *result, int n) 
...
inline void pcmpeqd(FG_UINT32 *a, FG_UINT32 *b, FG_UINT32 *result, int n) 
...
inline void pcmpgtb(FG_UINT8 *a, FG_UINT8 *b, FG_UINT8 *result, int n) 
/* Packed bytewise compare of memory ((a>b) ? 0xff : 0x00)             */
/* WARNING-- n must be divisible by 8!                                  */
{
#ifndef _HAS_MMX
...
inline void pcmpgtw(FG_UINT8 *a, FG_UINT8 *b, FG_UINT8 *result, int n) 
...
inline void pcmpgtd(FG_UINT32 *a, FG_UINT32 *b, FG_UINT32 *result, int n) 
/* Packed intwise compare of memory (( a>b ) ? 0xffffffff : 0x00000000)  */
/* WARNING-- n must be divisible by 2!                                   */
{
#ifndef _HAS_MMX
...
inline void pmaddwd(MMXR *a, MMXR *b, MMXR *result, int n)
...
{ 
  ...
  MMXR temp;
  for (i=0;i<n;i++) {
    temp.sdw[0]=(FG_INT32)a[i].sw[0]*(FG_INT32)b[i].sw[0]+
                (FG_INT32)a[i].sw[1]*(FG_INT32)b[i].sw[1];
    temp.sdw[1]=(FG_INT32)a[i].sw[2]*(FG_INT32)b[i].sw[2]+
                (FG_INT32)a[i].sw[3]*(FG_INT32)b[i].sw[3];
    result[i].sqw=temp.sqw;
  }
#else
/* until gas supports mmx, this won't work */
  __asm__ ("
...
inline void pmulhw(MMXR *a, MMXR *b, MMXR *result, int n)
...
{ 
  ...
  for (i=0;i<n;i++) {
    for (j=0;j<4;j++) {
      result[i].sw[j]=((FG_INT32)a[i].sw[j]*(FG_INT32)b[i].sw[j])>>16;
    }
  }
#else
/* until gas supports mmx, this won't work */
...
inline void pmullw(MMXR *a, MMXR *b, MMXR *result, int n)
...
{ 
  ...
  for (i=0;i<n;i++) {
    for (j=0;j<4;j++) {
      result[i].sw[j]=((FG_INT32)a[i].sw[j]*(FG_INT32)b[i].sw[j]) & 0xffff;
    }
  }
#else
/* until gas supports mmx, this won't work */
...
inline void por(FG_VOID *a, FG_VOID *b, FG_VOID *result, int n) 
/* Packed add of n bytes                                                */
/* WARNING-- n must be divisible by 8!                                  */
{
#ifndef _HAS_MMX
...
inline void psllw(FG_UINT16 *a, int count, FG_UINT16 *result, int n) 
...
inline void pslld(FG_UINT32 *a, int count, FG_UINT32 *result, int n) 
...
inline void psllq(FG_UINT64 *a, int count, FG_UINT64 *result, int n) 
/* Performs a logical shift left on an array of words                   */
{
#ifndef _HAS_MMX
  register int i;
...
inline void psraw(FG_UINT16 *a, int count, FG_UINT16 *result, int n) 
...
inline void psrad(FG_UINT32 *a, int count, FG_UINT32 *result, int n) 
/* Performs a logical shift left on an array of double words            */
/* WARNING-- n must be divisible by 2!                                  */
{
#ifndef _HAS_MMX
...
inline void psrlw(FG_UINT16 *a, int count, FG_UINT16 *result, int n) 
/* Performs a logical shift left on an array of words                   */
/* WARNING-- n must be divisible by 4!                                  */
{
#ifndef _HAS_MMX
...
inline void psrld(FG_UINT32 *a, int count, FG_UINT32 *result, int n) 
/* Performs a logical shift left on an array of double words            */
/* WARNING-- n must be divisible by 2!                                  */
{
#ifndef _HAS_MMX
...
inline void psrlq(FG_UINT64 *a, int count, FG_UINT64 *result, int n) 
/* Performs a logical shift left on an array of words                   */
{
#ifndef _HAS_MMX
  register int i;
...
inline void psubb(FG_UINT8 *a, FG_UINT8 *b, FG_UINT8 *result , int n) 
/* Packed add of n bytes with overflow  result[i]=a[i]-b[i]     */
/* WARNING-- n must be divisible by 8!                          */
{
#ifndef _HAS_MMX
...
inline void psubw(FG_UINT16 *a, FG_UINT16 *b, FG_UINT16 *result , int n) 
/* Packed add of n words with overflow  result[i]=a[i]-b[i]     */
/* WARNING-- n must be divisible by 4!                          */
{
#ifndef _HAS_MMX
...
inline void psubd(FG_UINT32 *a, FG_UINT32 *b, FG_UINT32 *result, int n)
/* Packed add of n double words  with overflow  *result=*a-*b           */
/* WARNING-- n must be divisible by 2!                          */
{
#ifndef _HAS_MMX
...
inline void psubsb(FG_INT8 *a, FG_INT8 *b, FG_INT8 *result, int n) 
/* Packed add of n signed bytes with saturation  result[i]=a[i]+b[i]  */
/* WARNING-- n must be divisible by 8!                                */
{
#ifndef _HAS_MMX
...
inline void psubsw(FG_INT16 *a, FG_INT16 *b, FG_INT16 *result, int n) 
/* Packed add of n signed words with saturation  result[i]=a[i]+b[i]  */
/* WARNING-- n must be divisible by 4!                                */
{
#ifndef _HAS_MMX
...
inline void psubusb(FG_UINT8 *a, FG_UINT8 *b, FG_UINT8 *result, int n) 
/* Packed add of n unsigned bytes with saturation  result[i]=a[i]+b[i]  */
/* WARNING-- n must be divisible by 8!                                  */
{
#ifndef _HAS_MMX
  register FG_INT k,i,j;
  for (k=0;k<n;k+=8) {
    for (i=0;i<8;i++) {
      j=a[k+i]-b[k+i];
      if (j<0) {
...
inline void psubusw(FG_UINT16 *a, FG_UINT16 *b, FG_UINT16 *result, int n) 
/* Packed add of n unsigned words with saturation  result[i]=a[i]+b[i]  */
/* WARNING-- n must be divisible by 4!                                  */
{
#ifndef _HAS_MMX
...
inline void punpckbw(FG_UINT8 *a, FG_UINT8 *b, FG_UINT16 *result, int n)
...
inline void punpckwd(FG_UINT16 *a, FG_UINT16 *b, FG_UINT32 *result, int n)
...
inline void punpckdq(FG_UINT32 *a, FG_UINT32 *b, MMXR *result, int n)
/* Unpacks words into dwords in interleaved fashion with b going into the */
/* high order  word (b=NULL will zero extend)                             */
/* WARNING- n must be divisible by 2!                                     */
{
...
inline void pxor(FG_VOID *a, FG_VOID *b, FG_VOID *result, int n) 
/* Packed add of n bytes                                                */
/* WARNING-- n must be divisible by 8!                                  */
{
#ifndef _HAS_MMX
