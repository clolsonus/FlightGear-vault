 ...
 * $Id: fgfont.h,v 2.1 1996/10/31 18:12:04 korpela Exp korpela $
 */
#include "fgtypes.h"
...
FGFONT_PIXMAP *fg_scale_font(FGFONT_PIXMAP *font,int width, int height);
FGFONT_PIXMAP *fg_get_font(int width, int height);
FGFONT_PIXMAP *fg_load_font(FGFONT_BITS *fontbits);

void fgfont_init();
void fg_drawtext(char *text, FGFONT_PIXMAP *font, int x, int y, int color, FG_BITMAP *bmp);
/* $Log: fgfont.h,v $
