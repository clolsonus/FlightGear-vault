 ...
 * $Id: fgdriver.h,v 2.2 1996/11/24 23:47:15 korpela Exp korpela $
 */
...
typedef struct _FGDRIVER_INIT_CALL {
	FG_INT32     struct_size;            /* set to sizeof(FGDRIVER_INIT_CALL) for    */
												  /* version identification              */
	FG_INT32     msg;                    /* type of call                        */
	FG_PUBVARS *public_vars;           /* pointer to shared variables         */
...
typedef struct _FGDRIVER_INIT {
	FG_INT32         struct_size;        /* set to sizeof(FGDRIVER_INIT) for    */
												  /* version identification              */
	FG_UINT32        driver_flags;       /* flags (see below)                   */
} FGDRIVER_INIT;
